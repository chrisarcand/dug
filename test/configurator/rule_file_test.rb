...
class RuleFileTest < Minitest::Test
  ...
  def test_it_configures_all_values_as_expected
    ...
    assert_equal Dug.configuration.label_for(:repository, 'rspec-expectations', organization: 'rspec'), 'RSpec/rspec-expectations'
    assert_equal Dug.configuration.label_for(:repository, 'more_core_extensions', organization: 'ManageIQ'), 'MoreCoreExtensions'
    ...
    assert_equal Dug.configuration.label_for(:reason, 'mention'), 'Mentioned by name'
